...
public class MouseInput implements MouseListener, MouseMotionListener {
	...
	public void mouseClicked(MouseEvent e) { //called when mouse is clicked and it is not moving
		
	}

	
	public void mousePressed(MouseEvent e) { //called when mouse is clicked and movement does not matter
