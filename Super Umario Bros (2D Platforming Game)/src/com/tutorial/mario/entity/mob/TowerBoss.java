...
public class TowerBoss extends Entity {
	...
	public void render(Graphics g) {
		g.drawImage(Game.towerBoss.getBufferedImage(), x, y, width, height,null );
	...
	public void tick() {
		...
		if((phaseTime>=100&&bossState ==BossState.IDLE)||(phaseTime>=600&&bossState!=BossState.SPINNING)) chooseState();
		
		if(bossState == BossState.RECOVERING && phaseTime >=100) {
